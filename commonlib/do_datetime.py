...
def to_timestamp(dt_str, tz_str):
    dt=re.match(r'^(1[0-9]{3}|200[0-9]|[201[0-7]|[0-9]{1,4})[: -\/_]+(0[0-9]|1[0-9]|2[0-3]|[0-9])\:(0[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9]|[0-9])\:(0[0-9]|1[0-9]|2[0-9]|3[0-9]|4[0-9]|5[0-9]|[0-9])',dt_str).group()
